...
@NgModule({
  ...
  providers: [CepService, DadosService, ExperienciasService, usuarioDeslogado, HabilidadesService, SkillService, Services, LoginService, AuthGuardService, AdminGuardService, ListarExperienciaPorIdComponent],
